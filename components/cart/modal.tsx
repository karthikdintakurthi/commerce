    ...
    <>
      ...
      <Transition show={isOpen}>
        <Dialog onClose={closeCart} className="relative z-50">
          ...
          >
            <Dialog.Panel className="fixed bottom-0 right-0 top-0 flex h-full w-full flex-col border-l border-border bg-background/95 p-6 text-foreground backdrop-blur-xl md:w-[390px]">
...
function CloseCart({ className }: { className?: string }) {
  return (
    <div className="relative flex h-11 w-11 items-center justify-center rounded-md border border-border text-foreground transition-colors hover:bg-accent hover:text-accent-foreground">
      <XMarkIcon
        className={clsx(
...
function CheckoutButton() {
  ...
  return (
           <button
             className="block w-full rounded-full bg-primary p-3 text-center text-sm font-medium text-primary-foreground hover:bg-primary-700"
             type="submit"
             disabled={pending}
           >
